                        ...
                        <div class="d-flex  flex-shrink-0 p-3" style="width: 222px; background-color: rgb(201, 205, 207); border-top-left-radius: 1rem; border-top-right-radius: 1rem; height: 15rem; ">
                            ...
                            <ul class="nav nav-pills flex-column mb-auto" style="width: 25rem;">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button class="mt-2 text-center" style=" width: 5rem; border-radius: 5px; border: #13D659; background-color: #13D659; color: white;">Iniciar</button>
                                </div>
                            </ul>
                            <hr>
                        </div>
                ...
                <div>
                    <div class="d-flex justify-content-around ">
                        ...
                        <div class="d-flex justify-content-right ml-5">
                            <button class="mt-1 text-center" style=" width: 5rem; height: 50px; border-radius: 5px; border: #13D659; background-color: #13D659; color: white;">
